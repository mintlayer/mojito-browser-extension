...
// Integration tests that require real API connection
// Run with: npm test -- --testPathPatterns="Electrum" --testNamePattern="Integration"
describe.skip('Integration tests (require network)', () => {

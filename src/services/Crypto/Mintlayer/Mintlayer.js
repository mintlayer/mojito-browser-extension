...
// import * as wasm from './@mintlayerlib-js/wasm_wrappers.js'
// import * as wasmWrapper from './@mintlayerlib-js/wasm_wrappers_bg.wasm'
...
// export const initWasm = async () => {
//   await wasm.__wbg_set_wasm(wasmWrapper)
// }

// export const getPrivateKeyFromMnemonic = (mnemonic, networkType) => {
//   const networkIndex = NETWORKS[networkType]
//   return wasm.make_default_account_privkey(mnemonic, networkIndex)
// }

// export const getReceivingAddress = (defAccPrivateKey, keyIndex) => {
//   return wasm.make_receiving_address(defAccPrivateKey, keyIndex)
// }

// export const getChangeAddress = (defAccPrivateKey, keyIndex) => {
//   return wasm.make_change_address(defAccPrivateKey, keyIndex)
// }

// export const getPublicKeyFromPrivate = (privateKey) => {
//   return wasm.public_key_from_private_key(privateKey)
// }

// export const getPubKeyString = (pubkey, network) => {
//   return wasm.pubkey_to_pubkeyhash_address(pubkey, network)
// }
...
// export const getEncodedOutpointSourceId = (txId) => {
//   return wasm.encode_outpoint_source_id(txId, wasm.SourceId.Transaction)
// }

// export const getTxInput = (outpointSourceId, index) => {
//   return wasm.encode_input_for_utxo(outpointSourceId, index)
// }
...
//   const amountInstace = wasm.Amount.from_atoms(amount)

//   const networkIndex = NETWORKS[networkType]
//   if (type === 'Transfer') {
//     if (tokenId) {
//       return wasm.encode_output_token_transfer(
//         amountInstace,
//         address,
//         tokenId,
//         networkIndex,
//       )
//     } else {
//       return wasm.encode_output_transfer(amountInstace, address, networkIndex)
//     }
//   }
//   if (type === 'LockThenTransfer') {
//     let lockEncoded
//     if (lock.type === 'UntilTime') {
//       lockEncoded = wasm.encode_lock_until_time(BigInt(lock.content.timestamp))
//     }
//     if (lock.type === 'ForBlockCount') {
//       lockEncoded = wasm.encode_lock_for_block_count(BigInt(lock.content))
//     }
//     return wasm.encode_output_lock_then_transfer(
//       amountInstace,
//       address,
//       lockEncoded,
//       networkIndex,
...
//   if (type === 'spendFromDelegation') {
//     const stakingMaturity = getStakingMaturity(chainTip, networkType)
//     const encodedLockForBlock = wasm.encode_lock_for_block_count(stakingMaturity)
//     return wasm.encode_output_lock_then_transfer(
//       amountInstace,
//       address,
//       encodedLockForBlock,
...
// export const getTransaction = (inputs, outputs) => {
//   const flags = BigInt(0)
//   return wasm.encode_transaction(inputs, outputs, flags)
// }
...
// ) => {
//   const networkIndex = NETWORKS[networkType]
//   return wasm.encode_witness(
//     wasm.SignatureHashType.ALL,
//     privateKey,
//     address,
//     transaction,
//     inputs,
...
// export const getEncodedSignedTransaction = (transaction, witness) => {
//   return wasm.encode_signed_transaction(transaction, witness)
// }
...
// ) => {
//   const networkIndex = NETWORKS[networkType]
//   return wasm.estimate_transaction_size(
//     inputs,
//     inputAddresses,
//     outputs,
//     networkIndex,
...
// export const getDelegationOutput = (poolId, address, networkType) => {
//   const networkIndex = NETWORKS[networkType]
//   return wasm.encode_output_create_delegation(poolId, address, networkIndex)
// }

// export const getStakingOutput = (amount, delegationId, networkType) => {
//   const networkIndex = NETWORKS[networkType]
//   const amountInstace = wasm.Amount.from_atoms(amount)
//   return wasm.encode_output_delegate_staking(
//     amountInstace,
//     delegationId,
//     networkIndex,
//   )
...
// export const getStakingMaturity = (blockHeight, networkType) => {
//   const networkIndex = NETWORKS[networkType]
//   return wasm.staking_pool_spend_maturity_block_count(
//     BigInt(Number(blockHeight)),
//     networkIndex,
//   )
// }
...
//   const networkIndex = NETWORKS[networType]
//   const amountInstace = wasm.Amount.from_atoms(amount)
//   return wasm.encode_input_for_withdraw_from_delegation(
//     delegationId,
//     amountInstace,
//     BigInt(Number(nonce)),
//     networkIndex,
